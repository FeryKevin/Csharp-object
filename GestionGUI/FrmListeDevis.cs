    ...
    public partial class FrmListeDevis : Form
    {
        ...
        private void ModifierDevis_Click(object sender, EventArgs e)
        {
            ...
            if (txtQte.Text == "" || txtRemise.Text.ToString() == "")
            {
                ...
                Produit pro = new Produit((Int32)dgvProduitsDevis.CurrentRow.Cells[0].Value, dgvProduitsDevis.CurrentRow.Cells[1].Value.ToString(), float.Parse(dgvProduitsDevis.CurrentRow.Cells[2].Value.ToString()), 
                    new Categorie(0, dgvProduitsDevis.CurrentRow.Cells[3].Value.ToString()),
                    new Pays(0, dgvProduitsDevis.CurrentRow.Cells[4].Value.ToString(), float.Parse(dgvProduitsDevis.CurrentRow.Cells[5].Value.ToString())));
                int qte, remise;
                temp = txtQte.Text;
