...
namespace GestionDAL
{
    public class ContenirDAO
    {
        ...
        public static List<Contenir> GetContenir(int code_devis)
        {
            ...
            cmd.CommandText = "SELECT * FROM informations, pays WHERE code_devis = " + code_devis;
            ...
            while (monReader.Read())
            {
                ...
                unPays = new Pays(code_pays, nom, augmentation);

                unStatut = new Statut(code_statut, libelle_statut);

                unProduit = new Produit(code_produit, libelle_produit, prix_produit, uneCategorie, unPays);
