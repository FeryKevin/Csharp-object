    ...
    public class ProduitDAO
    {
        ...
        public static List<Produit> GetProduit()
        {
            ...
            cmd.CommandText = " SELECT * FROM produit," +
                ...
                "AND produit.id_pays = pays.id_pays";
            ...
            while (monReader.Read())
            {
                ...
                code_pays = Int32.Parse(monReader["id_pays"].ToString());
                ...
                unProduit = new Produit(code, libelle, prix, new Categorie(code_cat, lib_categorie), new Pays (code_pays, nom, augmentation));
        ...
        public static int SelectPaysProduit(int id)
        {
            int nbEnr;
            ...
            cmd.CommandText = "SELECT id_pays as pay FROM pays WHERE id_pays = " + id;
        ...
        public static int AjoutProduit(Produit unProduit)
        {
            ...
            cmd.CommandText = "INSERT INTO produit values (@libelle, @prix, @codeCategorie, @idPays)";
            ...
            cmd.Parameters.Add(new SqlParameter("@idPays", System.Data.SqlDbType.Int));
            cmd.Parameters["@idPays"].Value = unProduit.Pays.Code;
        ...
        public static int UpdateProduit(Produit unProduit)
        {
            ...
            cmd.Parameters.Add(new SqlParameter("@id_pays", System.Data.SqlDbType.Int));
            cmd.Parameters["@id_pays"].Value = unProduit.Pays.Code;
